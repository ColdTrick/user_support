...
return array (
  'user_support:notify:admin:create:subject' => 'Se ha reportado un nuevo ticket de soporte %s',
  'user_support:notify:admin:updated:subject' => 'Se ha actualizado un ticket de soporte %s',
...
%s',
  ...
  'widgets:faq:description' => 'Mostrar una lista de los elementos más recientes añadidos al FAQ',
  'widgets:support_ticket:name' => 'Tickets de soporte',
  'widgets:support_ticket:description' => 'Muestra una lista de tus tickets de soporte',
